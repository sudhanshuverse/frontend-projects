...
">
  ...
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./01-qr-code-card/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./02-card-project/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./03-youtube-header/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./04-column-preview-card-component/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./05-css-grid-testimonial-section/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./06-e-commerce-card/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./07-custom-search-bar/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./08-profile-card-with-share-functionality/screenshot.png" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./09-tooltips/screenshot.gif" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
  <div style="flex: 1 1 480px; max-width: 500px;">
    <img src="./10-custom-dropwon/screenshot.gif" style="width: 100%; height: 320px; object-fit: cover; border-radius: 14px;">
  </div>
